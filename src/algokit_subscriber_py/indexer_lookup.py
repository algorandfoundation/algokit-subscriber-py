...
from .types.indexer import AccountLookupResult, ApplicationCreatedLookupResult, ApplicationResult, AssetBalancesLookupResult, LookupAssetHoldingsOptions, MiniAssetHolding, TransactionLookupResult, TransactionResult, TransactionSearchResults
...
def lookup_account_created_application_by_address(
    ...
    """
    def extract_items(response: ApplicationCreatedLookupResult) -> list[ApplicationResult]:
