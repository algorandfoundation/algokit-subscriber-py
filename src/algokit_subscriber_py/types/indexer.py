...
TransactionSearchResults = TypedDict("TransactionSearchResults", {
    "current-round": int,
    "next-token": str,
    "transactions": list['TransactionResult']
})

AccountLookupResult = TypedDict("AccountLookupResult", {
    "current-round": int,
    "account": 'AccountResult'
})

AssetsLookupResult = TypedDict("AssetsLookupResult", {
    "current-round": int,
    "next-token": str,
    "assets": list['AssetHolding']
})

AssetsCreatedLookupResult = TypedDict("AssetsCreatedLookupResult", {
    "current-round": int,
    "next-token": str,
    "assets": list['AssetResult']
})

ApplicationCreatedLookupResult = TypedDict("ApplicationCreatedLookupResult", {
    "current-round": int,
    "next-token": str,
    "applications": list['ApplicationResult']
})

AssetLookupResult = TypedDict("AssetLookupResult", {
    "current-round": int,
    "asset": 'AssetResult'
})

LookupAssetHoldingsOptions = TypedDict("LookupAssetHoldingsOptions", {
    "currency-less-than": NotRequired[float],
    "currency-greater-than": NotRequired[float],
    "include-all": NotRequired[bool]
})

AssetBalancesLookupResult = TypedDict("AssetBalancesLookupResult", {
    "current-round": int,
    "next-token": str,
    "balances": list['MiniAssetHolding']
})

TransactionLookupResult = TypedDict("TransactionLookupResult", {
    "current-round": int,
    "transaction": 'TransactionResult'
})

ApplicationLookupResult = TypedDict("ApplicationLookupResult", {
    "current-round": int,
...
AccountResult = TypedDict("AccountResult", {
    "address": str,
    "amount": int,
...
PaymentTransactionResult = TypedDict("PaymentTransactionResult", {
    "amount": int,
...
StateProofTransactionResult = TypedDict("StateProofTransactionResult", {
    "message": 'StateProofMessage',
    "state-proof": 'StateProof',
    "state-proof-type": int
})

StateProofMessage = TypedDict("StateProofMessage", {
...
StateProof = TypedDict("StateProof", {
...
StateProofReveal = TypedDict("StateProofReveal", {
    "position": int,
...
StateProofVerifier = TypedDict("StateProofVerifier", {
    "commitment": str,
    "key-lifetime": int
})

StateProofSigSlot = TypedDict("StateProofSigSlot", {
    "lower-sig-weight": int,
    "signature": 'MerkleSignature'
})

MerkleSignature = TypedDict("MerkleSignature", {
...
MerkleArrayProof = TypedDict("MerkleArrayProof", {
    "hash-factory": 'HashFactory',
    "path": list[str],
    "tree-depth": int
})

HashFactory = TypedDict("HashFactory", {
    "hash-type": int
})

ApplicationTransactionResult = TypedDict("ApplicationTransactionResult", {
...
AssetConfigTransactionResult = TypedDict("AssetConfigTransactionResult", {
    "asset-id": int,
    "params": NotRequired['AssetParams']
})

AssetFreezeTransactionResult = TypedDict("AssetFreezeTransactionResult", {
    "address": str,
    "asset-id": int,
    "new-freeze-status": bool
})

AssetTransferTransactionResult = TypedDict("AssetTransferTransactionResult", {
    "amount": int,
    "asset-id": int,
    "close-amount": NotRequired[None | int],
...
KeyRegistrationTransactionResult = TypedDict("KeyRegistrationTransactionResult", {
...
AssetResult = TypedDict("AssetResult", {
    "index": int,
    "deleted": NotRequired[bool],
    "created-at-round": NotRequired[int],
...
ApplicationResult = TypedDict("ApplicationResult", {
    "id": int,
...
LogicTransactionSignature = TypedDict("LogicTransactionSignature", {
...
MultisigTransactionSubSignature = TypedDict("MultisigTransactionSubSignature", {
    "public-key": str,
    "signature": NotRequired[str]
})
...
ApplicationParams = TypedDict("ApplicationParams", {
    "creator": str,
...
AssetParams = TypedDict("AssetParams", {
    "creator": str,
    "decimals": int,
    "total": int,
...
AccountParticipation = TypedDict("AccountParticipation", {
...
AppLocalState = TypedDict("AppLocalState", {
...
AssetHolding = TypedDict("AssetHolding", {
    "amount": int,
    "asset-id": int,
    "deleted": NotRequired[bool],
    "is-frozen": bool,
...
MiniAssetHolding = TypedDict("MiniAssetHolding", {
    "address": str,
    "amount": int,
    "deleted": NotRequired[bool],
    "is-frozen": bool,
