...
from algokit_subscriber.types.subscription import AlgorandSubscriberConfig, BalanceChangeRole
...
def test_block_payouts() -> None:
    ...
    config: AlgorandSubscriberConfig = {
        "filters": [{
            "name": "payout",
            "filter": {
                "custom_filter": synthetic_filter
            },
        }],
    ...
    algod_subscriber = AlgorandSubscriber(config=config, algod_client=algorand.client.algod, indexer_client=algorand.client.indexer)
    ...
    indexer_subscriber = AlgorandSubscriber(config=config, algod_client=algorand.client.algod, indexer_client=algorand.client.indexer)
